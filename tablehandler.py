...
class TableHandler(object):
    ...
    def __init__(self, s3credsfile, 
        ...
        if 'days' in kwargs:
            ...
            raise ValueError(f'you have to specify days or years in TableHandler!') 
        ...
        # self.S3_CREDENTIALS = json.load(open(s3credsfile, 'r'))
...
if __name__ == '__main__':
     ...
     tc = TableHandler( s3credsfile='config/creds-s3.json',
                        days=1).start_session(sqlcredsfile="config/conn-01.ini")
